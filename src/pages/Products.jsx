...
function Products() {
  ...
  if (loading) {
    return <Loader mensaje="Estamos preparando nuestro catálogo para ti..." />;
  }
              ...
              <Card className="product-card-modern h-100 w-100 border-0">
                ...
                <Card.Body className="d-flex flex-column p-4">
                  ...
                  <Button
                    ...
                    className={`w-100 py-2 fw-semibold transition-all ${addedId === p.id ? 'btn-success-custom' : 'btn-primary-custom'
                      }`}
                    disabled={p.stock <= 0}
                  >
                    {addedId === p.id ? (
